...
export default class extends React.Component {
  ...
  static propTypes = {
    ...
    actionOpacity: PropTypes.number,
  };
    ...
    return (
      <View style={
        ...
        </View>
        {
          ...
          ? <TouchableOpacity activeOpacity={this.props.actionOpacity} style={[styles.actionWrapper, {flex:searchBoxFlex}]} onPress={this.props.actionFunc}>
